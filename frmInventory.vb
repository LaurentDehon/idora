...
Public Class frmInventory
    ...
    Private Sub frmInventory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If INVENTORYBindingSource.Count = 0 Then ShowRoomInput()
            LoadPics()
            LoadPicsO()
            ShowPics()
            CheckInventory()
...
#Region "Miscellaneous"
    Private Sub Trad()
        ...
        If Lang = 1 Then
            ...
            ToolTip.SetToolTip(txtNumR, "Ruimte code")
            ToolTip.SetToolTip(txtDescR, "Naam en/of beschrijving van de ruimte")
            ...
            ToolTip.SetToolTip(btnSeizure, "Naar Vesta gebracht")
        ...
        Else
            ...
            ToolTip.SetToolTip(txtNumR, "Code de la zone")
            ToolTip.SetToolTip(txtDescR, "Nom et/ou description de la zone")
            ...
            ToolTip.SetToolTip(btnSeizure, "Emmené à Vesta")
